...
import { proxyGet, proxyPost, type ApiResponse, type LiquidationChartItem, type LiquidationExchangeItem, type LiquidationOrderItem, type MarketETFFlowItem, type MarketFearGreedHistoryItem, type MarketFuturesItem, type MarketIndicatorItem, type MarketMetricPoint, type MarketOptionsItem, type MarketTopCoinItem } from './api'
...
export async function fetchMarketEtf(params: { symbol: 'BTC' | 'ETH'; sort_by?: 'flow_usd' | 'timestamp'; order?: 'asc' | 'desc'; from?: string; to?: string }) {
  ...
  return proxyGet<ApiResponse<MarketETFFlowItem>>(`market/etf`, qs)
}
...
export async function fetchMarketFearGreed(params?: { from?: string; to?: string }) {
  ...
  if (params?.from !== undefined) qs['from'] = String(params.from)
  if (params?.to !== undefined) qs['to'] = String(params.to)
  return proxyGet<ApiResponse<MarketFearGreedHistoryItem>>(`market/fear-greed`, qs)
}
...
export async function fetchMarketFutures(params?: { sort_by?: 'open_interest' | 'funding_rate' | 'volume_24h' | 'long_short_ratio'; order?: 'asc' | 'desc' }) {
  ...
  qs['order'] = String(params?.order ?? 'desc')
  return proxyGet<ApiResponse<MarketFuturesItem>>(`market/futures`, qs)
}
...
export async function fetchMarketLiquidationChart(params: { symbol: string; interval?: '1m' | '3m' | '5m' | '15m' | '30m' | '1h' | '4h' | '6h' | '8h' | '12h' | '1d' | '1w'; exchange?: 'Binance' | 'OKX' | 'Bybit' | 'Bitget' | 'Hyperliquid' | 'Gate' | 'HTX' | 'Bitmex' | 'Bitfinex' | 'CoinEx' | 'Aster' | 'Lighter'; limit?: number; from?: string; to?: string }) {
  ...
  if (params?.from !== undefined) qs['from'] = String(params.from)
  if (params?.to !== undefined) qs['to'] = String(params.to)
  return proxyGet<ApiResponse<LiquidationChartItem>>(`market/liquidation/chart`, qs)
}
...
export async function fetchMarketLiquidationExchangeList(params?: { symbol?: string; time_range?: '1h' | '4h' | '12h' | '24h'; sort_by?: 'liquidation_usd' | 'long_liquidation_usd' | 'short_liquidation_usd'; order?: 'asc' | 'desc' }) {
  ...
  qs['order'] = String(params?.order ?? 'desc')
  return proxyGet<ApiResponse<LiquidationExchangeItem>>(`market/liquidation/exchange-list`, qs)
}
...
export async function fetchMarketLiquidationOrder(params?: { exchange?: 'Binance' | 'OKX' | 'Bybit' | 'Bitget' | 'Hyperliquid' | 'Gate' | 'HTX' | 'Bitmex' | 'Bitfinex' | 'CoinEx' | 'Aster' | 'Lighter'; symbol?: string; min_amount?: string; side?: 'long' | 'short'; sort_by?: 'usd_value' | 'timestamp' | 'price'; order?: 'asc' | 'desc'; from?: string; to?: string }) {
  ...
  if (params?.from !== undefined) qs['from'] = String(params.from)
  if (params?.to !== undefined) qs['to'] = String(params.to)
  return proxyGet<ApiResponse<LiquidationOrderItem>>(`market/liquidation/order`, qs)
}
...
export async function fetchMarketOnchainIndicator(params: { symbol: 'BTC' | 'ETH'; metric: 'nupl' | 'sopr' | 'mvrv' | 'puell-multiple' | 'nvm' | 'nvt' | 'nvt-golden-cross' | 'exchange-flows/inflow' | 'exchange-flows/outflow' | 'exchange-flows/netflow' | 'exchange-flows/reserve'; granularity?: 'day'; from?: string; to?: string; exchange?: 'all_exchange' | 'spot_exchange' | 'derivative_exchange' | 'binance' | 'bybit' | 'kraken' | 'okx' }) {
  ...
  return proxyGet<ApiResponse<MarketMetricPoint>>(`market/onchain-indicator`, qs)
}
...
export async function fetchMarketOptions(params: { symbol: 'BTC' | 'ETH' | 'SOL' | 'XRP' | 'BNB' | 'DOGE' | 'ADA' | 'AVAX'; sort_by?: 'open_interest' | 'volume_24h'; order?: 'asc' | 'desc' }) {
  ...
  qs['sort_by'] = String(params?.sort_by ?? 'volume_24h')
  qs['order'] = String(params?.order ?? 'desc')
  return proxyGet<ApiResponse<MarketOptionsItem>>(`market/options`, qs)
}
...
export async function fetchMarketPrice(params: { symbol: string; time_range?: '1d' | '7d' | '14d' | '30d' | '90d' | '180d' | '365d' | 'max'; from?: string; to?: string; currency?: string }) {
  ...
  return proxyGet<ApiResponse<MarketMetricPoint>>(`market/price`, qs)
}
...
export async function fetchMarketPriceIndicator(params: { indicator: 'rsi' | 'macd' | 'ema' | 'sma' | 'bbands' | 'stoch' | 'adx' | 'atr' | 'cci' | 'obv' | 'vwap' | 'dmi' | 'ichimoku' | 'supertrend'; symbol: string; interval?: '1m' | '5m' | '15m' | '30m' | '1h' | '2h' | '4h' | '12h' | '1d' | '1w'; exchange?: 'binance' | 'bybit' | 'coinbase' | 'kraken'; from?: string; to?: string; options?: string }) {
  ...
  return proxyGet<ApiResponse<MarketIndicatorItem>>(`market/price-indicator`, qs)
}
...
export function useMarketEtf(params: Parameters<typeof fetchMarketEtf>[0], opts?: QueryOpts<ApiResponse<MarketETFFlowItem>>) {
...
export function useMarketFearGreed(params?: Parameters<typeof fetchMarketFearGreed>[0], opts?: QueryOpts<ApiResponse<MarketFearGreedHistoryItem>>) {
...
export function useMarketFutures(params?: Parameters<typeof fetchMarketFutures>[0], opts?: QueryOpts<ApiResponse<MarketFuturesItem>>) {
...
export function useMarketLiquidationChart(params: Parameters<typeof fetchMarketLiquidationChart>[0], opts?: QueryOpts<ApiResponse<LiquidationChartItem>>) {
...
export function useMarketLiquidationExchangeList(params?: Parameters<typeof fetchMarketLiquidationExchangeList>[0], opts?: QueryOpts<ApiResponse<LiquidationExchangeItem>>) {
...
export function useMarketLiquidationOrder(params?: Parameters<typeof fetchMarketLiquidationOrder>[0], opts?: QueryOpts<ApiResponse<LiquidationOrderItem>>) {
...
export function useMarketOnchainIndicator(params: Parameters<typeof fetchMarketOnchainIndicator>[0], opts?: QueryOpts<ApiResponse<MarketMetricPoint>>) {
...
export function useMarketOptions(params: Parameters<typeof fetchMarketOptions>[0], opts?: QueryOpts<ApiResponse<MarketOptionsItem>>) {
...
export function useMarketPrice(params: Parameters<typeof fetchMarketPrice>[0], opts?: QueryOpts<ApiResponse<MarketMetricPoint>>) {
...
export function useMarketPriceIndicator(params: Parameters<typeof fetchMarketPriceIndicator>[0], opts?: QueryOpts<ApiResponse<MarketIndicatorItem>>) {
...
// ---------------------------------------------------------------------------
// Market infinite query hooks (auto-pagination)
// ---------------------------------------------------------------------------
...
/** Get token rankings — infinite-scroll wrapper with automatic offset pagination. */
export function useInfiniteMarketRanking(params?: Omit<Parameters<typeof fetchMarketRanking>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<MarketTopCoinItem>>) {
  return useInfiniteQuery({
    queryKey: ['market', 'ranking', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchMarketRanking({ ...params, offset: pageParam }),
    initialPageParam: 0,
