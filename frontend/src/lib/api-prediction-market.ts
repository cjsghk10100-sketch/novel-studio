...
import { proxyGet, proxyPost, type ApiResponse, type KalshiEvent, type KalshiMarketItem, type KalshiOIPoint, type KalshiPricePoint, type KalshiTrade, type KalshiVolumePoint, type PolymarketActivity, type PolymarketEvent, type PolymarketMarketItem, type PolymarketOIPoint, type PolymarketPosition, type PolymarketPricePoint, type PolymarketRankingItem, type PolymarketTrade, type PolymarketVolumePoint, type PredictionMarketCategoryMetricsItem } from './api'
 ...
 * - limit?: Maximum rows to return (default: 200) @min 1 @max 10000
 ...
 * - time_range?: Predefined time range: `7d`, `30d`, `90d`, `180d`, or `1y` (default: 30d)
 */
export async function fetchPredictionMarketKalshiOpenInterest(params: { ticker: string; time_range?: '7d' | '30d' | '90d' | '180d' | '1y' }) {
  const qs: Record<string, string> = {}
 ...
 * - ticker: Market ticker identifier
 * - time_range?: Predefined time range: `7d`, `30d`, `90d`, `180d`, or `1y`. Ignored when `interval=latest`. (default: 30d)
 * - interval?: Data interval: `1h` for hourly, `1d` for daily OHLC, `latest` for real-time price from trades (default: 1d)
 */
export async function fetchPredictionMarketKalshiPrices(params: { ticker: string; time_range?: '7d' | '30d' | '90d' | '180d' | '1y'; interval?: '1h' | '1d' | 'latest' }) {
  const qs: Record<string, string> = {}
  qs['ticker'] = String(params.ticker)
  qs['time_range'] = String(params?.time_range ?? '30d')
 ...
 * - offset?: Pagination offset (default: 0) @min 0
 */
export async function fetchPredictionMarketKalshiRanking(params?: { sort_by?: 'notional_volume_usd' | 'open_interest'; order?: 'asc' | 'desc'; status?: 'active' | 'closed' | 'determined' | 'disputed' | 'finalized' | 'inactive' | 'initialized'; category?: 'crypto' | 'culture' | 'economics' | 'financials' | 'politics' | 'stem' | 'sports' | 'unknown'; limit?: number; offset?: number }) {
  if (params?.limit !== undefined) params.limit = Math.max(1, Math.min(100, params?.limit))
  if (params?.offset !== undefined) params.offset = Math.max(0, params?.offset)
  const qs: Record<string, string> = {}
 ...
 * - time_range?: Predefined time range: `7d`, `30d`, `90d`, `180d`, or `1y` (default: 30d)
 */
export async function fetchPredictionMarketKalshiVolumes(params: { ticker: string; time_range?: '7d' | '30d' | '90d' | '180d' | '1y' }) {
  const qs: Record<string, string> = {}
  qs['ticker'] = String(params.ticker)
  qs['time_range'] = String(params?.time_range ?? '30d')
 ...
 * - offset?: Pagination offset (default: 0) @min 0
 */
export async function fetchPredictionMarketPolymarketActivity(params: { address: string; limit?: number; offset?: number }) {
  if (params.limit !== undefined) params.limit = Math.max(1, Math.min(100, params.limit))
  if (params.offset !== undefined) params.offset = Math.max(0, params.offset)
  const qs: Record<string, string> = {}
  ...
  qs['limit'] = String(params?.limit ?? 50)
  qs['offset'] = String(params?.offset ?? 0)
  return proxyGet<ApiResponse<PolymarketActivity>>(`prediction-market/polymarket/activity`, qs)
}
 ...
 */
export async function fetchPredictionMarketPolymarketOpenInterest(params: { condition_id: string; time_range?: '7d' | '30d' | '90d' | '180d' | '1y' }) {
  const qs: Record<string, string> = {}
 ...
 * - offset?: Pagination offset (default: 0) @min 0
 */
export async function fetchPredictionMarketPolymarketPositions(params: { address: string; limit?: number; offset?: number }) {
  if (params.limit !== undefined) params.limit = Math.max(1, Math.min(100, params.limit))
  if (params.offset !== undefined) params.offset = Math.max(0, params.offset)
  const qs: Record<string, string> = {}
  qs['address'] = String(params.address)
 ...
 */
export async function fetchPredictionMarketPolymarketPrices(params: { condition_id: string; time_range?: '7d' | '30d' | '90d' | '180d' | '1y'; interval?: '1h' | '1d' | 'latest' }) {
  const qs: Record<string, string> = {}
  qs['condition_id'] = String(params.condition_id)
  qs['time_range'] = String(params?.time_range ?? '30d')
  qs['interval'] = String(params?.interval ?? '1d')
 ...
 * - offset?: Pagination offset (default: 0) @min 0
 */
export async function fetchPredictionMarketPolymarketRanking(params?: { sort_by?: 'notional_volume_usd' | 'open_interest'; order?: 'asc' | 'desc'; status?: 'active' | 'finalized' | 'ended' | 'initialized' | 'closed'; category?: 'crypto' | 'culture' | 'early_polymarket_trades' | 'economics' | 'financials' | 'politics' | 'stem' | 'sports' | 'unknown'; end_before?: '24h' | '3d' | '7d' | '14d' | '30d'; limit?: number; offset?: number }) {
...
Data refresh: ~30 minutes
 * - condition_id?: Market condition identifier
 * - address?: Wallet address — returns trades where the address is maker or taker
 ...
 * - offset?: Pagination offset (default: 0) @min 0
 */
export async function fetchPredictionMarketPolymarketTrades(params?: { condition_id?: string; address?: string; outcome_label?: 'Yes' | 'No'; min_amount?: number; from?: string; to?: string; sort_by?: 'timestamp' | 'notional_volume_usd'; limit?: number; offset?: number }) {
  if (params?.min_amount !== undefined) params.min_amount = Math.max(0, params?.min_amount)
  if (params?.limit !== undefined) params.limit = Math.max(1, Math.min(500, params?.limit))
  if (params?.offset !== undefined) params.offset = Math.max(0, params?.offset)
  const qs: Record<string, string> = {}
 ...
 */
export async function fetchPredictionMarketPolymarketVolumes(params: { condition_id: string; time_range?: '7d' | '30d' | '90d' | '180d' | '1y'; interval?: '1h' | '1d' }) {
  const qs: Record<string, string> = {}
  qs['condition_id'] = String(params.condition_id)
  qs['time_range'] = String(params?.time_range ?? '30d')
  qs['interval'] = String(params?.interval ?? '1d')
...
/** Get Polymarket wallet activity — wraps `fetchPredictionMarketPolymarketActivity` with React Query caching. */
export function usePredictionMarketPolymarketActivity(params: Parameters<typeof fetchPredictionMarketPolymarketActivity>[0], opts?: QueryOpts<ApiResponse<PolymarketActivity>>) {
  return useQuery({ queryKey: ['prediction', 'market', 'polymarket', 'activity', params], queryFn: () => fetchPredictionMarketPolymarketActivity(params!), ...opts })
}
...
// ---------------------------------------------------------------------------
// Prediction Market infinite query hooks (auto-pagination)
// ---------------------------------------------------------------------------
...
/** Get prediction market category metrics — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketCategoryMetrics(params?: Omit<Parameters<typeof fetchPredictionMarketCategoryMetrics>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<PredictionMarketCategoryMetricsItem>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'category', 'metrics', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketCategoryMetrics({ ...params, offset: pageParam }),
    initialPageParam: 0,
...
/** Get Kalshi events — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketKalshiEvents(params: Omit<Parameters<typeof fetchPredictionMarketKalshiEvents>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<KalshiEvent>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'kalshi', 'events', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketKalshiEvents({ ...params!, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get Kalshi markets — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketKalshiMarkets(params: Omit<Parameters<typeof fetchPredictionMarketKalshiMarkets>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<KalshiMarketItem>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'kalshi', 'markets', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketKalshiMarkets({ ...params!, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get top Kalshi markets — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketKalshiRanking(params?: Omit<Parameters<typeof fetchPredictionMarketKalshiRanking>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<KalshiMarketItem>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'kalshi', 'ranking', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketKalshiRanking({ ...params, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get Kalshi trades — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketKalshiTrades(params: Omit<Parameters<typeof fetchPredictionMarketKalshiTrades>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<KalshiTrade>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'kalshi', 'trades', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketKalshiTrades({ ...params!, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get Polymarket wallet activity — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketPolymarketActivity(params: Omit<Parameters<typeof fetchPredictionMarketPolymarketActivity>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<PolymarketActivity>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'polymarket', 'activity', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketPolymarketActivity({ ...params!, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get Polymarket events — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketPolymarketEvents(params: Omit<Parameters<typeof fetchPredictionMarketPolymarketEvents>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<PolymarketEvent>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'polymarket', 'events', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketPolymarketEvents({ ...params!, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get Polymarket markets — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketPolymarketMarkets(params: Omit<Parameters<typeof fetchPredictionMarketPolymarketMarkets>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<PolymarketMarketItem>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'polymarket', 'markets', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketPolymarketMarkets({ ...params!, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get Polymarket positions — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketPolymarketPositions(params: Omit<Parameters<typeof fetchPredictionMarketPolymarketPositions>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<PolymarketPosition>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'polymarket', 'positions', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketPolymarketPositions({ ...params!, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get top Polymarket markets — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketPolymarketRanking(params?: Omit<Parameters<typeof fetchPredictionMarketPolymarketRanking>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<PolymarketRankingItem>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'polymarket', 'ranking', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketPolymarketRanking({ ...params, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
...
/** Get Polymarket trades — infinite-scroll wrapper with automatic offset pagination. */
export function useInfinitePredictionMarketPolymarketTrades(params?: Omit<Parameters<typeof fetchPredictionMarketPolymarketTrades>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<PolymarketTrade>>) {
  return useInfiniteQuery({
    queryKey: ['prediction', 'market', 'polymarket', 'trades', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchPredictionMarketPolymarketTrades({ ...params, offset: pageParam }),
    initialPageParam: 0,
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.total || !meta?.limit) return undefined
