...
import { proxyGet, proxyPost, type ApiResponse, type ApiObjectResponse, type ApiCursorResponse, type MindshareTopProject, type SmartFollowerHistoryPoint, type SocialDetailBody, type SocialMindsharePoint, type XTweet, type XUser } from './api'
 ...
 * - from?: Start timestamp. Accepts Unix seconds (1704067200) or date string (2024-01-01)
 * - to?: End timestamp. Accepts Unix seconds (1706745600) or date string (2024-02-01)
 */
export async function fetchSocialMindshare(params: { q: string; interval: '5m' | '1h' | '1d' | '7d'; from?: string; to?: string }) {
  const qs: Record<string, string> = {}
...
export async function fetchSocialTweetReplies(params: { tweet_id: string; limit?: number; cursor?: string }) {
  ...
  return proxyGet<ApiCursorResponse<XTweet>>(`social/tweet/replies`, qs)
}
...
export async function fetchSocialUserFollowers(params: { handle: string; limit?: number; cursor?: string }) {
  ...
  qs['limit'] = String(params?.limit ?? 20)
  if (params?.cursor !== undefined) qs['cursor'] = String(params.cursor)
  return proxyGet<ApiCursorResponse<XUser>>(`social/user/followers`, qs)
}
...
export async function fetchSocialUserFollowing(params: { handle: string; limit?: number; cursor?: string }) {
  ...
  qs['limit'] = String(params?.limit ?? 20)
  if (params?.cursor !== undefined) qs['cursor'] = String(params.cursor)
  return proxyGet<ApiCursorResponse<XUser>>(`social/user/following`, qs)
}
...
export async function fetchSocialUserPosts(params: { handle: string; limit?: number; cursor?: string; filter?: 'all' | 'original' }) {
  ...
  return proxyGet<ApiCursorResponse<XTweet>>(`social/user/posts`, qs)
}
...
export async function fetchSocialUserReplies(params: { handle: string; limit?: number; cursor?: string }) {
  ...
  qs['limit'] = String(params?.limit ?? 20)
  if (params?.cursor !== undefined) qs['cursor'] = String(params.cursor)
  return proxyGet<ApiCursorResponse<XTweet>>(`social/user/replies`, qs)
}
...
export function useSocialTweetReplies(params: Parameters<typeof fetchSocialTweetReplies>[0], opts?: QueryOpts<ApiCursorResponse<XTweet>>) {
...
export function useSocialUserFollowers(params: Parameters<typeof fetchSocialUserFollowers>[0], opts?: QueryOpts<ApiCursorResponse<XUser>>) {
...
export function useSocialUserFollowing(params: Parameters<typeof fetchSocialUserFollowing>[0], opts?: QueryOpts<ApiCursorResponse<XUser>>) {
...
export function useSocialUserPosts(params: Parameters<typeof fetchSocialUserPosts>[0], opts?: QueryOpts<ApiCursorResponse<XTweet>>) {
...
export function useSocialUserReplies(params: Parameters<typeof fetchSocialUserReplies>[0], opts?: QueryOpts<ApiCursorResponse<XTweet>>) {
  return useQuery({ queryKey: ['social', 'user', 'replies', params], queryFn: () => fetchSocialUserReplies(params!), ...opts })
}

// ---------------------------------------------------------------------------
// Social infinite query hooks (auto-pagination)
// ---------------------------------------------------------------------------
...
/** Get top projects by mindshare — infinite-scroll wrapper with automatic offset pagination. */
export function useInfiniteSocialRanking(params?: Omit<Parameters<typeof fetchSocialRanking>[0], 'offset'>, opts?: OffsetInfiniteOpts<ApiResponse<MindshareTopProject>>) {
  return useInfiniteQuery({
    queryKey: ['social', 'ranking', 'infinite', params],
    queryFn: ({ pageParam = 0 }) => fetchSocialRanking({ ...params, offset: pageParam }),
    initialPageParam: 0,
...
/** Get tweet replies — infinite-scroll wrapper with automatic cursor pagination. */
export function useInfiniteSocialTweetReplies(params: Omit<Parameters<typeof fetchSocialTweetReplies>[0], 'cursor'>, opts?: CursorInfiniteOpts<ApiCursorResponse<XTweet>>) {
  return useInfiniteQuery({
    queryKey: ['social', 'tweet', 'replies', 'infinite', params],
    queryFn: ({ pageParam }) => fetchSocialTweetReplies({ ...params!, ...(pageParam ? { cursor: pageParam } : {}) }),
    initialPageParam: '',
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
...
/** Get user followers list — infinite-scroll wrapper with automatic cursor pagination. */
export function useInfiniteSocialUserFollowers(params: Omit<Parameters<typeof fetchSocialUserFollowers>[0], 'cursor'>, opts?: CursorInfiniteOpts<ApiCursorResponse<XUser>>) {
  return useInfiniteQuery({
    queryKey: ['social', 'user', 'followers', 'infinite', params],
    queryFn: ({ pageParam }) => fetchSocialUserFollowers({ ...params!, ...(pageParam ? { cursor: pageParam } : {}) }),
    initialPageParam: '',
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.has_more || !meta?.next_cursor) return undefined
...
/** Get user following list — infinite-scroll wrapper with automatic cursor pagination. */
export function useInfiniteSocialUserFollowing(params: Omit<Parameters<typeof fetchSocialUserFollowing>[0], 'cursor'>, opts?: CursorInfiniteOpts<ApiCursorResponse<XUser>>) {
  return useInfiniteQuery({
    queryKey: ['social', 'user', 'following', 'infinite', params],
    queryFn: ({ pageParam }) => fetchSocialUserFollowing({ ...params!, ...(pageParam ? { cursor: pageParam } : {}) }),
    initialPageParam: '',
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.has_more || !meta?.next_cursor) return undefined
...
/** Get user social posts — infinite-scroll wrapper with automatic cursor pagination. */
export function useInfiniteSocialUserPosts(params: Omit<Parameters<typeof fetchSocialUserPosts>[0], 'cursor'>, opts?: CursorInfiniteOpts<ApiCursorResponse<XTweet>>) {
  return useInfiniteQuery({
    queryKey: ['social', 'user', 'posts', 'infinite', params],
    queryFn: ({ pageParam }) => fetchSocialUserPosts({ ...params!, ...(pageParam ? { cursor: pageParam } : {}) }),
    initialPageParam: '',
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.has_more || !meta?.next_cursor) return undefined
...
/** Get user replies — infinite-scroll wrapper with automatic cursor pagination. */
export function useInfiniteSocialUserReplies(params: Omit<Parameters<typeof fetchSocialUserReplies>[0], 'cursor'>, opts?: CursorInfiniteOpts<ApiCursorResponse<XTweet>>) {
  return useInfiniteQuery({
    queryKey: ['social', 'user', 'replies', 'infinite', params],
    queryFn: ({ pageParam }) => fetchSocialUserReplies({ ...params!, ...(pageParam ? { cursor: pageParam } : {}) }),
    initialPageParam: '',
    getNextPageParam: (lastPage) => {
      const meta = (lastPage as any)?.meta
      if (!meta?.has_more || !meta?.next_cursor) return undefined
